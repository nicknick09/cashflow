  ...
  async (payload, { rejectWithValue }) => {
    try {
      const response = await api.methods.postData(
        'https://techstephub.focusrtech.com:5050/CashForecasting/api/auth/forgetPassword',
        payload
      );
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const response = await api.methods.putData(
        'https://techstephub.focusrtech.com:5050/CashForecasting/api/auth/updateNewPassword',
        payload
      );
      return response.data;
    } catch (err) {
